...
const About = () => {
  ...
  const summary = "Cellular automata is a dynamic model that evolves in discrete time steps based on the state and transition rules. Therefore, the basis of the CA model is a well fit for the simulation of the network evolution history in cancer."
